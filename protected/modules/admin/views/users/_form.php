...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        ...
        <div class="hint">Оставьте поле пустым если не хотите изменять</div>
        <?php endif; ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'role'); ?>
        <?php echo $form->dropDownList($model, 'role', array('user' => 'Пользователь системы','administrator' => 'Администратор')); ?>
